...
if (!data || !token) {
	...
	fetch('http://localhost:3000/contacto/todos', {
		method: 'GET',
		headers: {
	...
	fetch('http://localhost:3000/compania/todos', {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: 'Bearer ' + token,
	...
	fetch('http://localhost:3000/localizacion/regiones', {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: 'Bearer ' + token,
	...
	const getCountries = (e) => {
		...
		fetch(`http://localhost:3000/localizacion/${id}/paises`, {
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
				Authorization: 'Bearer ' + token,
	...
	const getCountries2 = async (e) => {
		let id = e.target.value;
		let response = await fetch(`http://localhost:3000/localizacion/${id}/paises`, {
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
				Authorization: 'Bearer ' + token,
	...
	const getCities = (e) => {
		let id = e.target.value;
		fetch(`http://localhost:3000/localizacion/${id}/ciudades`, {
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
				Authorization: 'Bearer ' + token,
